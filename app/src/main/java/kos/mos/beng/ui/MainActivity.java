...
public class MainActivity extends BaseActivity {
    ...
    private final int[] RES_ON = {R.drawable.v_pill_on, R.drawable.v_gear_on, R.drawable.v_flower_on};
    private final int[] RES = {R.drawable.v_pill, R.drawable.v_gear, R.drawable.v_flower};
    ...
    public void changeIcon(int index) {
        ...
        for (int i = 0; i < menuSize; i++) {
            if (i == index) {
                ...
                ((TextView) views.get(i).getChildAt(1)).setTextColor(ContextCompat.getColor(this, R.color.default_color));
            } else {
